    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div className="glass fade-in" style={{ width: "100%", maxWidth: "420px", padding: "40px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <h1 style={{ fontSize: "26px", fontWeight: 800, marginBottom: "8px", color: "var(--text-primary)" }}>Welcome back</h1>
          <p style={{ color: "var(--text-secondary)", fontSize: "14px" }}>Log in to continue your anime journey</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <label htmlFor="email" style={{ display: "block", fontSize: "13px", fontWeight: 600, color: "var(--text-secondary)", marginBottom: "8px" }}>Email</label>
          ...
          <button id="login-submit" type="submit" className="btn-primary" disabled={loading} style={{ width: "100%", justifyContent: "center", padding: "13px", fontSize: "15px", marginTop: "4px", opacity: loading ? 0.7 : 1 }}>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "var(--text-secondary)" }}>
          ...
          <Link href="/signup" style={{ color: "var(--accent-light)", fontWeight: 600, textDecoration: "none" }}>Sign up free</Link>
        </p>
      </div>
    </div>
  );
